...
export const es: TranslationKey = {
  ...
  profile: {
    ...
    rosterBackup: 'Copia de equipo y PC',
    rosterBackupHint: 'Exporta o importa tu equipo, PC, caja de muertos y pools de MT/reaprendizaje como JSON.',
    rosterExport: 'Exportar roster',
    rosterImport: 'Importar roster',
    rosterExportSuccess: 'Roster exportado de "{{name}}".',
    rosterImportTitle: 'Importar equipo y PC',
    rosterImportHint: 'Carga un JSON exportado de otro perfil. Reemplaza el equipo, PC, caja de muertos y pools de movimientos actuales.',
    rosterImportChooseFile: 'Elegir archivo JSON',
    rosterImportPlaceholder: 'O pega aquí el JSON del roster…',
    rosterImportPreview:
      'De "{{name}}": {{team}} equipo, {{box}} PC, {{deathBox}} muertos, {{tms}} MT, {{relearn}} reaprendizaje ({{count}} Pokémon en total).',
    rosterImportAction: 'Importar roster',
    rosterImportReplaceConfirm:
      '¿Reemplazar el equipo, PC, caja de muertos y pools de movimientos actuales con los datos importados? No se puede deshacer.',
    rosterImportSuccess: 'Importados {{count}} Pokémon de "{{name}}".',
    rosterImportInvalidJson: 'JSON inválido. Elige un archivo de exportación o pega JSON válido.',
    rosterImportInvalidFormat: 'Formato no reconocido. Usa una exportación de roster de esta app.',
    rosterImportUnsupportedVersion: 'Versión de exportación no compatible. Actualiza la app e inténtalo de nuevo.',
    rosterImportEmpty: 'El archivo no tiene equipo, PC ni pools de movimientos para importar.',
  },
  search: {
  ...
  moveLearn: {
    title: 'Aprender movimientos',
    subtitle:
      'Lista tus MTs, elige un Pokémon y mira movimientos enseñables por MT y reaprendibles según su tabla por nivel en PokeAPI.',
    tmPoolTitle: 'MTs y MOs que tienes',
    tmPoolHint: 'Añade cada movimiento de MT/MO disponible en la mochila.',
    tmPoolEmpty: 'Aún no hay movimientos.',
    tmPoolAttacksCount: '{{count}} movimientos en la mochila',
    seeAttacks: 'Ver ataques ({{count}})',
    hideAttacks: 'Ocultar ataques',
    removeMove: 'Quitar {{name}}',
    addMove: 'Añadir movimiento',
    movePlaceholder: 'ej. rayo',
    rosterTitle: 'Equipo y PC',
    rosterSearchLabel: 'Buscar en equipo y PC',
    rosterSearchPlaceholder: 'Buscar Pokémon…',
    rosterSearchEmpty: 'Ningún Pokémon coincide con la búsqueda.',
    emptyRoster: 'Añade Pokémon al equipo o al PC primero.',
    onTeam: 'Equipo',
    inBox: 'PC',
    currentMoves: 'Movimientos actuales',
    showMoveDetails: 'Ver más detalles',
    hideMoveDetails: 'Menos detalle',
    expandMove: 'Toca para ver detalles',
    collapseMove: 'Ocultar detalles',
    learnMove: 'Aprender',
    learnDialogTitle: '¿Qué movimiento reemplazar?',
    learnDialogHint: 'Elige un espacio en {{pokemon}} para enseñar {{move}}.',
    slotLabel: 'Espacio {{n}}',
    emptySlot: 'Vacío',
    ...
    relearnResultsEmpty:
      'No hay movimientos por nivel reaprendibles a este nivel en tu versión del juego.',
    tmUnavailableHint: 'Este Pokémon no puede aprender estos MT en tu versión del juego.',
    badgeTm: 'MT',
    badgeRelearn: 'Recordar',
    learnedAtLevel: 'Nv {{level}}',
    alreadyKnown: 'Ya lo sabe',
    cannotLearnCount: '{{count}} no puede aprender',
  },
}
