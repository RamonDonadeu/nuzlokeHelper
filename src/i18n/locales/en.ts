...
export const en: TranslationKey = {
  ...
  moveLearn: {
    ...
    rosterTitle: 'Team & PC',
    rosterSearchLabel: 'Search team and PC',
    rosterSearchPlaceholder: 'Search Pokémon…',
    rosterSearchEmpty: 'No Pokémon match your search.',
    ...
    learnMove: 'Learn',
    learnDialogTitle: 'Replace which move?',
    learnDialogHint: 'Choose a slot on {{pokemon}} to teach {{move}}.',
    slotLabel: 'Slot {{n}}',
    emptySlot: 'Empty',
